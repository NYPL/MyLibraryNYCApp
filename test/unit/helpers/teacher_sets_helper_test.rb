      ...
      es_json = {:totalMatches=>1330,
                 :hits=>
                  [{"_index"=>"teacherset",
                    ...
                    "_score"=>1.0,
                    "_source"=>
                     {"title"=>"Step Up to the Plate, Maria Singh by deepika.",
                      "description"=> "Book Club Set (10 books) - Nine-year-old Maria Singh learns to play softball just like her heroes in the All-American Girls' League, while her parents and neighbors are struggling through World War II, working for India's independence, and trying to stay on their farmland.",
                      ...
                      "area_of_study"=>"English Language Arts", "subjects"=>[{"id"=>65025, "title"=>"East Indian Americans", "created_at"=>"2020-05-11T16:39:52+0000", "updated_at"=>"2020-05-11T16:39:52+0000"}]},"sort"=>[1.0, "available", 1589311935000, "352"]}]}
