...
ActiveRecord::Schema.define(version: 2021_04_23_130759) do
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.integer "school_id"
    t.text "alt_barcodes"
    t.index "lower((alt_email)::text)", name: "index_users_on_alt_email_lower"
    t.index "lower((email)::text)", name: "index_users_on_email_lower"
    t.index "lower((email)::text), lower((alt_email)::text)", name: "index_users_on_email_or_alt_email_lower"
    t.index ["alt_email"], name: "index_users_on_alt_email"
