...
class User < ActiveRecord::Base
  ...
  # Does this user have the secondary barcode field filled in in the MLN db?
  def multiple_barcodes_in_mln?
  ...
  # Calculate the next barcode to be assigned to a user.
  def assign_barcode
