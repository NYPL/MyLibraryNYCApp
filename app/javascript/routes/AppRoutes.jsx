    ...
    <DSProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route path='/contacts' element={ <Contacts userSignedIn={userSignedIn} hideSignInMsg={hide_signin_msg} signInMsg={signin_msg} />} />
          ...
          <Route path='/signup' element={ <SignUp userSignedIn={userSignedIn} handleLogin={handleLogin} />} />
          <Route path='/signout' element={ <SignOut />} />
          <Route path='/teacher_set_data' element={ <SearchTeacherSets userSignedIn={userSignedIn} hideSignInMsg={hide_signin_msg} signInMsg={signin_msg} />} />
