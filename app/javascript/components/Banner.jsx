...
function Banner() {
  return (
    ...
    <a href="mailto:help@mylibrarynyc.org"> help@mylibrarynyc.org </a> for all general questions and 
    <a href="mailto:delivery@mylibrarynyc.org"> delivery@mylibrarynyc.org </a> for all delivery questions.</>} />
