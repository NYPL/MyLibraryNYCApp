...
function Banner() {
  return (
    <Notification ariaLabel="Banner Notification" id="banner-notification" className="bannerMessage" centered showIcon={false} dismissible notificationType={NotificationTypes.Announcement} notificationContent={<>
