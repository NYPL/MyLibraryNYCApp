...
export default function MobileHeader(props) {
  ...
  const displayColorModeIcon = () => {
    if (defaultColorMode === "dark") {
      return <li id="mobile-color-mode-icon" onClick={handleChangeToDarkMode} class="mobileBrightnessIcon">
      ...
      return <li id="mobile-color-mode-icon" onClick={handleChangeToDarkMode} class="mobileDarkModeIcon">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
