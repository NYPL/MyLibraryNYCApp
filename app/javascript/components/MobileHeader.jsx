...
import HeaderMobileNavButton from "./HeaderMobileNavButton/HeaderMobileNavButton";
    ...
    <HStack __css={styles.container}>
      ...
      <Box ref={ref}>
        <FocusLock isDisabled={!isOpen}>
          ...
          {isOpen && <HeaderMobileNavButton details={props}/>}
        </FocusLock>
      </Box>
    </HStack>
...
//   const styles = useMultiStyleConfig("MobileHeader", {});
