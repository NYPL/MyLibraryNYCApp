...
module MlnResponse
  ...
  BIB_RECORD_SUPPRESSED_REMOVED_FROM_DB     = {code: 'MLN-00015', msg: 'Bib is suppressed in Sierra; Bib was removed from MyLibraryNYC'}.freeze
  BIB_RECORD_SUPPRESSED_NOT_ADDED_TO_DB     = {code: 'MLN-00016', msg: 'Bib is suppressed in Sierra; Bib was not added to MyLibraryNYC'}.freeze
end
